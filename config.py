...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5502075149:AAGdK0XXMu29M-pLOKZEyFG47Td1jk8wZjk")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "5047866686 2072769117 2018095690 1850233338 5876695183 5145607305 6275310033").split()):
        ADMINS.append(int(x))
except ValueError:
